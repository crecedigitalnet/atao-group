            ...
            <Reveal key={`${s.city}-${s.address}`} delay={i * 80}>
              <article className="surface-card h-full p-7">
                ...
                <a
                  ...
                  className="mt-5 inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white transition hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                >
                  <MapPin className="h-4 w-4" aria-hidden="true" />
                  Ver Ubicación
                  <span className="sr-only"> de {s.city} en Google Maps</span>
                </a>
              </article>
            </Reveal>
          ))}
